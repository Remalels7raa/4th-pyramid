      ...
      <div className='container bg-zinc-200  max-w-7xl px-5 py-16 shadow-gray-400 shadow-xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-0'>
        ...
        <div className='h-full mx-5 shadow-gray-400 shadow-xl rounded-lg  overflow-hidden'>
          <iframe
            ...
            allowFullScreen=''
            title='شارع حمزة بن عبد المطلب, الرياض'
          ></iframe>
        </div>
        ...
        <div className='py-5 px-4'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-3'>
            {/* الموقع */}
            <div className='bg-gray-50 p-6 rounded-xl shadow-xl shadow-gray-400 '>
            ...
            {/* البريد الإلكتروني */}
            <div className='bg-gray-50 p-6 rounded-xl shadow-xl shadow-gray-400 md:col-span-2'>
